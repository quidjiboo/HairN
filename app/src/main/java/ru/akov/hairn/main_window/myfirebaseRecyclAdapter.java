...
public class myfirebaseRecyclAdapter extends FirebaseRecyclerAdapter {
    /**
     ...
     */
    public myfirebaseRecyclAdapter(Class<Typs_of_shop> modelClass, int modelLayout, Class<mViewHolder> viewHolderClass, Query ref) {
