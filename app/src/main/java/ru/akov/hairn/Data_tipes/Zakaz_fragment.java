...
public class Zakaz_fragment {
    ...
    public Zakaz_fragment() {
        // Default constructor required for calls to DataSnapshot.getValue(User.class)
    }

    public Zakaz_fragment(String clienid, String magazinid, String mail, String name, String phone, String uslugi, String date, String clock, String status) {
